		...
		for (int row = 0; row < boardSize; row++) {
			for (int col = 0; col < boardSize; col++) {
				...
				if (board[row][col] != null) {
					...
					if (row == 0 && col == edge) {
						// left filled
						if ((board[0][edge - 1] != null &&
								board[1][edge] == null)) {
							if (board[row][col].getPlayerNumber() !=
									board[0][edge - 1].getPlayerNumber()) {
								board[row][col].setRiskLevel(3);
							}
						}
					...
					if (row == edge && col == 0) {
						// right filled
						if ((board[edge][1] != null &&
								board[edge - 1][0] == null)) {
							if (board[edge][col].getPlayerNumber() !=
									board[edge][1].getPlayerNumber()) {
								board[row][col].setRiskLevel(3);
							}
						}
						...
						if ((board[edge][1] == null &&
								board[edge - 1][0] != null)) {
							if (board[edge][col].getPlayerNumber() !=
									board[edge - 1][0].getPlayerNumber()) {
								board[row][col].setRiskLevel(3);
							}
						}
					...
					if (row == edge && col == edge) {
						// left filled
						if ((board[edge][edge - 1] != null &&
								board[edge - 1][edge] == null)) {
							if (board[edge][edge].getPlayerNumber() !=
									board[edge][edge - 1].getPlayerNumber()) {
								board[row][col].setRiskLevel(3);
							}
						}
						...
						if ((board[edge][edge - 1] == null &&
								board[edge - 1][edge] != null)) {
							if (board[edge][edge].getPlayerNumber() !=
									board[edge - 1][edge].getPlayerNumber()) {
								board[row][col].setRiskLevel(3);
							}
						}
			...
			for (int col = 0; col < boardSize; col++)
				if (board[row][col] != null) {
					...
					if (row == edge && col == 0)
						if (board[edge][1] != null &&
								board[edge - 1][0] != null)
							if (board[edge][0].getPlayerNumber() !=
									board[edge - 1][0].getPlayerNumber() &&
									board[edge][0].getPlayerNumber() !=
											board[edge][1].getPlayerNumber())
								possibleEliminations.add(board[row][col].getPlayerNumber());
					...
					if (row == 0 && col == edge)
						if (board[0][edge - 1] != null &&
								board[1][edge] != null)
							if (board[0][edge].getPlayerNumber() !=
									board[1][edge].getPlayerNumber() &&
									board[0][edge].getPlayerNumber() !=
											board[0][edge - 1].getPlayerNumber())
								possibleEliminations.add(board[row][col].getPlayerNumber());
					...
					if (row == edge && col == edge)
						if (board[edge][edge - 1] != null &&
							...
							if (board[edge][edge].getPlayerNumber() !=
									board[edge - 1][edge].getPlayerNumber() &&
									board[edge][edge].getPlayerNumber() !=
											board[edge][edge - 1].getPlayerNumber())
								possibleEliminations.add(board[row][col].getPlayerNumber());
