...
public class ChangeJar {
    ...
    public ChangeJar(ChangeJar other) {
        // Checks if any of the change in "other" is less than 0
...
// REMEMBER to use the Java Style Guide for the rest of your code.
    ...
    private static int convertToPennies (ChangeJar temp) {
        ...
        // Checks if any of the change in "temp" are less than 0
        if(temp.quarters < 0 || temp.dimes < 0 || temp.nickels < 0 || temp.pennies < 0) {
            throw new IllegalArgumentException();
        }

        // Returns the value of "temp" in pennies
...
//    }
     ...
     * OR will be 2 if any and all of the conditions above are not met
     */
    public int compareTo(ChangeJar s) {
        ...
        // Comparing the value of "this" ChangeJar with s
            ...
            // Returns 2 if all of these conditional statements do not occur
            // Note: Under normal circumstances, you should not be able to
            // see this happen
            return 2;
    }
     ...
     * OR will be 2 if any and all of the conditional statements are not met
     */
     ...
     * ChangeJar are negative OR if a ChangeJar does not return.
     */
    public ChangeJar takeOut (double amount) {
        ...
        // Throws an Illegal Argument if the given value is greater than
        // the value in the ChangeJar or if the value given is less than 0
        // or if mutate is off
        throw new IllegalArgumentException();
    }
    ...
    public void dec() {
        ...
        if(mutate) {
            ...
            // Checks if the pennies is less or equal to 0 on decrement and throws an error
