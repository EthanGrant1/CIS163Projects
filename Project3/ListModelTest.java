...
public class ListModelTest {
    ...
    // This method tests the error in getColumnCount
    @Test (expected = IllegalArgumentException.class)
    public void getColumnCountError() {
        ListModel list1 = new ListModel();

        // Setting the screen to a dummy variable
        ScreenDisplay test = ScreenDisplay.UpdateScreenErrorBypass;
        list1.setDisplay(test);

        list1.getColumnCount();
    }
    ...
    // This method tests the error in getValueAt
    @Test (expected = IllegalArgumentException.class)
    public void getValueAtError() {
        ListModel list1 = new ListModel();
    ...
    // This method checks if the estimated check out date
    // is null and prints the correct response
    @Test
    public void NullEstimatedCheckOutDate() {
        ListModel list1 = new ListModel();
        ...
        // Sets the estimated checkout date to null
        CampSite cmp = list1.getFileredListCampSites().get(0);
        cmp.setEstimatedCheckOut(null);

        // Checks that the printed result of the estimated
        // checkout date is nothing
        assertEquals ("-", list1.getValueAt(0, 3).toString());

        // Setting the screen to the OverDue screen
        test = ScreenDisplay.OverDueScreen;
        list1.setDisplay(test);

        // Sets the OverDue date
        GregorianCalendar EnteredOverDue = new GregorianCalendar(2021,Calendar.JANUARY,21);
        list1.setEnteredOverDueDate(EnteredOverDue);

        cmp = list1.getFileredListCampSites().get(0);
        cmp.setEstimatedCheckOut(null);

        assertEquals ("-", list1.getValueAt(0, 3).toString());

        // Setting the screen to the Sort by RV / Tent screen
        test = ScreenDisplay.SortByRVTent;
        list1.setDisplay(test);
        ...
        // Setting the screen to the Sort by Tent / RV screen
        test = ScreenDisplay.SortByTentRV;
        list1.setDisplay(test);
    ...
    // This method tests the error in getColumnName
    @Test (expected = RuntimeException.class)
    public void getColumnNameError() {
        ListModel list1 = new ListModel();
