...
public class ListModelTest {
    ...
    public void OverDueScreenNegDays() {
        ...
        // FIX ME: The number of days OverDue should be negative,
        // but is defaulting to zero. The overdue screen is working
        // perfectly as intended, but the getter is not giving the
        // right number
        System.out.println(list1.getDayCounter());
    }
