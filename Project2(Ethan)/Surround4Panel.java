    ...
    private void displayBoard() {
        ...
        for (int row = 0; row < boardSize; row++)
            for (int col = 0; col < boardSize; col++) {
                ...
                // FIX ME: After the getRiskLevel() method is created in
                // Cell class, the values will change the color of the board
                // here. (Sweep over the whole board and change JButton colors)
            }
    }
